...
<html>
	...
	<body>
		...
		<div id="center">
			<ul id="sidemenu">
				...
				<li class="treatment"><a href="#treatment">Animais a serem Tratados</a></li>
				<li class="hotel"><a href="#hotel">Hotel</a></li>
	...
	<script src="src/js/animalTreatment.js?<?= time(); ?>"></script>
</html>